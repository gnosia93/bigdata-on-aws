![zeppelin](https://github.com/gnosia93/bigdata-on-aws/blob/main/workshop/images/zeppelin.png)
...
AWS emr 콘솔에서 제플린 주소 확인 후, 브라우저로 제플린 노트북 연결한 하여 아래의 그림 처럼 새로운 노트북을 생성합니다. 
