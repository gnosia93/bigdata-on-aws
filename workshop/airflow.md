...
emr 의 하둡 및 스파크 잡을 remote 인 airflow 노드에서 실행하기 위해서 airflow ec2 인스턴스에 하둡 및 스파크 패키지를 설치하였습니다. (https://github.com/gnosia93/bigdata-on-aws/blob/main/tf/ec2.tf 의 userdata 참조)   
